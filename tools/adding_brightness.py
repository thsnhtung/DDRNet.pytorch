...
img_path = r'C:\Users\Asus\Desktop\AI\SegmentData\Simulation\train\image\Roud1_2_171.png'
...
def brightness_augment(img, factor=0.5): 
    ...
    for i in range(0,random.randint(1, 5)):
        ...
        rgb[shift_h_min:shift_h_max, shift_w_min:shift_w_max, :] = 255
...
while True:
    new_image = brightness_augment(org_image, factor= 0.6)
